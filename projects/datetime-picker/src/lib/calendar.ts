 ...
 * @docs-private
 */
export type NgxPlusifyCalendarView = 'month' | 'year' | 'multi-year';
...
export class NgxPlusifyCalendarHeader<D> {
  constructor(
    private _intl: NgxPlusifyDatepickerIntl,
    @Inject(forwardRef(() => NgxPlusifyCalendar))
    public calendar: NgxPlusifyCalendar<D>,
  ...
  implements AfterContentInit, AfterViewChecked, OnDestroy, OnChanges
{
  ...
  @Input() startView: NgxPlusifyCalendarView = 'month';
  ...
  @Output() readonly _userDragDrop = new EventEmitter<
    NgxPlusifyCalendarUserEvent<NgxDateRange<D>>
  >();

  /** Reference to the current month view component. */
  @ViewChild(NgxPlusifyMonthView) monthView: NgxPlusifyMonthView<D>;

  /** Reference to the current year view component. */
  @ViewChild(NgxPlusifyYearView) yearView: NgxPlusifyYearView<D>;

  /** Reference to the current multi-year view component. */
  @ViewChild(NgxPlusifyMultiYearView) multiYearView: NgxPlusifyMultiYearView<D>;
  ...
  constructor(
    _intl: NgxPlusifyDatepickerIntl,
    @Optional() private _dateAdapter: NgxPlusifyDateAdapter<D>,
    @Optional()
    @Inject(NGX_PLUSIFY_DATE_FORMATS)
    private _dateFormats: NgxPlusifyDateFormats,
    ...
    if (!this._dateFormats) {
      throw createMissingDateImplError('NGX_PLUSIFY_DATE_FORMATS');
    }
  ...
  _dateSelected(event: NgxPlusifyCalendarUserEvent<D | null>): void {
  ...
  _dragStarted(event: NgxPlusifyCalendarUserEvent<D>) {
   ...
   * of a new range.
   */
  _dragEnded(event: NgxPlusifyCalendarUserEvent<NgxDateRange<D> | null>) {
  ...
  private _getCurrentViewComponent():
    | NgxPlusifyMonthView<D>
    | NgxPlusifyYearView<D>
    | NgxPlusifyMultiYearView<D> {
